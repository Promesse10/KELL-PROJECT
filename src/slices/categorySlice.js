...
import { fetchCategories, createCategory, deleteCategory, updateCategory } from '../sevices/api';
...
// New Thunks
export const removeCategory = createAsyncThunk('category/removeCategory', deleteCategory);
export const editCategory = createAsyncThunk('category/editCategory', async ({ id, updatedCategory }) => {
